...
window.onload = function () {
   ...
   _mithril2.default.route(document.querySelector("routes"), "/", {
      ...
      "/db/:dbname/:tablename/:page": _tablePage2.default
   });
};
...
function view() {
    ...
    return {
        ...
        children: [{
            ...
            attrs: { className: "w3-navbar w3-border w3-light-grey" }
        }],
...
function controller() {
	...
	var self = this;
	self.columns = _mithril2.default.prop([]);
	self.dbname = _mithril2.default.route.param().dbname;
	self.tablename = _mithril2.default.route.param().tablename;
	self.page = _mithril2.default.route.param().page || 1;
	self.browseMessage = "Rows in '" + self.tablename + "' listed below";

	self.limit = 10;
	self.rows = _mithril2.default.prop([]);
	...
	self.listColumns = function () {
		_http2.default.post("/table/column/list", { dbname: self.dbname, tablename: self.tablename }).then(function (r) {
			...
			self.columns = _mithril2.default.prop(r.payload);
	...
	self.listRows = function (page) {
		_http2.default.post("/table/rows", {
			...
			self.rows = _mithril2.default.prop(r.payload);
		});
	};
	...
	self.goBack = function () {
		...
		_mithril2.default.route("/db/" + self.dbname + "/" + self.tablename + "/" + self.page);
	};
		...
		children: [{
			...
			children: [{
				...
				children: [{
					tag: 'a',
					children: ['Browse'],
					attrs: { href: 'javascript:void(0)', onclick: ctrl.openTab.bind(ctrl, 'Browse') }
				}]
			}, {
				tag: 'li',
				children: [{
					tag: 'a',
					children: ['Columns'],
					attrs: { href: 'javascript:void(0)', onclick: ctrl.openTab.bind(ctrl, 'Columns') }
				}]
			}],
			attrs: { className: 'w3-navbar w3-border w3-light-grey' }
		}, {
			tag: 'div',
			children: [_mithril2.default.component(_alert2.default, { message: ctrl.browseMessage }, []), {
				tag: 'ul',
				children: [{
					tag: 'li',
					children: [{
						tag: 'a',
						children: ['\u276E'],
						attrs: { href: 'javascript:void(0)', onclick: ctrl.goBack.bind(ctrl) }
					}]
				}, {
					tag: 'li',
					children: [{
						tag: 'a',
						children: ['\u276F'],
						attrs: { href: 'javascript:void(0)', onclick: ctrl.goForward.bind(ctrl) }
					}]
				}],
				attrs: { className: 'w3-pagination w3-border w3-round' }
			}, {
				tag: 'table',
				children: [{
					tag: 'thead',
					children: [{
						tag: 'tr',
						children: [ctrl.columns().map(function (r) {
							return {
								tag: 'th',
								children: [r.Field]
							};
					...
					tag: 'tbody',
					children: [ctrl.rows().map(function (row) {
						return {
							tag: 'tr',
							children: [ctrl.columns().map(function (column) {
								return {
									tag: 'td',
			...
			attrs: _defineProperty({ className: 'tab' }, 'className', ctrl.isOpened("Browse"))
		}, {
			tag: 'div',
			children: [{
				tag: 'table',
			...
			attrs: _defineProperty({ className: 'tab' }, 'className', ctrl.isOpened("Columns"))
		}]
	};
}
